...
## What This Is
Paper 2 of 3 from PhD dissertation: "Discrete Event Traffic Simulation Framework using Object-Driven Cellular Automata", targeting Transportation Research Part B.

## Project Layout
- `paper/` — LaTeX manuscript (`main.tex`)
