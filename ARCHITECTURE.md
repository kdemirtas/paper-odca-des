...
| diagnostics: `diagnose_fd_capacity.py`, `plot_car_following.py`, `plot_paradigm_comparison.py` | ring-road capacity check, car-following figure, and the NaSch against ODCA-DES representation figure `fig:paradigm` (D-2026-09-20-9, its scenario D-2026-09-20-12); may build simulations below the engine | entity, infrastructure, rng, analysis, `odca.baselines`, `config` | nothing. Write to `figures/` (`config.FIGURES_DIR`) |
