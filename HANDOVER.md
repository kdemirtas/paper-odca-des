...
2. **Close the open assumptions** with `/next-assumption`: the incident demand and closure (A-2026-09-20-2), the incident scenario (A-2026-09-20-2) and the odca-des rows. Closed 2026-09-20: the wall-time definition (D-2026-09-20-2) and the numbered revision files (D-2026-09-20-3).
