...
| Transportmetrica B | 6.1 (IF 3.4) | Q2 | quarterly | not published | moderate | good |
  ...
  **Both versions are now written (2026-09-20, D-2026-09-20-14), so this is a choice of file, not more work.** `paper/paper-odca-des_trb.tex` (45 pages) and `paper/paper-odca-des_smpt.tex` (46 pages) differ in the `\journal` line, the abstract opening, the introduction's first paragraph and a closing paragraph on the pattern's generality; everything else is shared and both build clean.
